...
#加载停用词
st = open(r"../dict/self_stopwords.txt", encoding='utf-8-sig', errors='ignore')
stopwords = [' ']  # 增加空格
for line in st:
    line = line.strip()
...
# 此种方法无效
#jieba.suggest_freq("???", tune=False)
#jieba.add_word('搞黄色', freq=20000)
#jieba.del_word('搞黄色')
print("自定义词典加载完毕")
#print(list(jieba.cut("???主播搞黄色？")))
