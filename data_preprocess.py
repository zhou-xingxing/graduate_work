...
segmentor.load_with_lexicon(cws_model_path, r"..\self_dict.txt")  # 加载模型，第二个参数是您的外部词典文件路径
...
# 只有结尾的!!!会分开
print(ltp_separate_word("哈哈哈    你好吗???"))


# fin="cleaned_test_room911_20000.csv"
# fout="ltp_separate_cleaned_test_room911_20000.csv"
# print("打开：" + fin)
# start_time = time.clock()
# with open(fin, 'r', encoding='utf-8') as f:
#     reader = csv.reader(f)
